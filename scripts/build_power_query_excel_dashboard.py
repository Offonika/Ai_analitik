...
def _write_dashboard(
    ...
    kpi_cards = [
        ...
        (
            "Прибыль до налогов",
            kpi.get("Прибыль до налогов")
            or kpi.get("Управленческая прибыль WB")
            or kpi.get("Маржинальный доход WB после налогов"),
            "rub",
        ),
        (
            "Маржинальность до налогов",
            kpi.get("Маржинальность до налогов")
            or kpi.get("Маржа WB без НДС")
            or kpi.get("Маржа WB после налогов"),
            "pct",
        ),
    ...
    monthly_small = [
        [
            ...
            row.get("Маржинальность до налогов")
