...
def _write_methodology(
    ...
    rows = [
        ...
        (
            ...
            "cogs_from_1c_with_extra_costs = управленческая прибыль WB; "
            "прибыль до налогов = управленческая прибыль WB - применимый "
            "профильный налог на доход, кроме НДФЛ предпринимателя; "
            "НДС к уплате показывается отдельно",
        ),
        (
            "СПП",
        ...
        (
            "Прибыль",
            "Текущий расчет не называется чистой прибылью бизнеса: итоговый "
            "товарный показатель — прибыль до налогов.",
        ),
