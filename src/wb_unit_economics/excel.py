...
def _write_readme(
    ...
    *,
    ...
    rows = [
        ...
        ("Налоги", "НДС внутри цены 5/105; УСН 1% от выручки"),
    ...
    notes = list(source_notes) or [
        ...
        (
            "НДС 5% выделяется из выручки по ставке 5/105, УСН 1% "
            "распределяется по выручке товара; 1С используется для сверки "
            "контрольных сумм."
        ),
...
def _write_summary(
    ...
    rows = [
        ...
        ("НДС 5% из выручки", totals["vat_5"]),
        ("УСН 1% от выручки", totals["usn_1"]),
        ("Маржинальный доход WB после налогов", totals["profit_after_taxes"]),
    ]
...
def _write_methodology(
    ...
    rows = [
        ...
        ("НДС 5%", "НДС считается внутри цены: net_revenue * 5 / 105."),
        ("УСН 1%", "УСН распределяется по товарам как net_revenue * 1%."),
        (
            "Сверка налогов",
