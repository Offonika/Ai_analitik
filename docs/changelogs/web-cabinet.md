...
- 2026-07-18: v2.59 скрыл технические logistics revisions из
  пользовательского сценария: staff UI автоматически использует самый новый
  разрешённый `ready` report run без смены публикации и URL. Для выбранного
  периода с неполными границами финансовые карточки используют явно
  подписанный максимальный вложенный интервал полных недель, сохраняя точную
  логистику всего периода и `null`-семантику его недельных KPI.
- 2026-07-18: v2.58 добавил безопасное staff-переключение со старого
