...
7. аналитические выводы и действия отдельно по каждому кабинету;
8. структура расходов WB и топ убыточных товаров;
9. возвраты и потенциально упущенные продажи;
10. качество данных и сверка с 1С;
11. налоговые настройки 1С;
12. общие действия;
13. открытые вопросы;
