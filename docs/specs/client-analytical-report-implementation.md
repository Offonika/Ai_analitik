...
- отдельный детерминированный раздел логистики
  `wb-logistics-insight-v1`: закрытый период, фактический расход, доля,
  влияние на прибыль, подтвержденные действия, partial-границы и статусы
  F-1…F-5;
...
4. основные KPI;
5. логистика: закрытый период, факты, влияние, действия и ограничения F-1…F-5;
